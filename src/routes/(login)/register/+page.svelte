...
<div class="content-center">
    <div class="form-container">
        ...
        <div class="form-group">
            <h6>รหัสผ่าน :</h6>
            <input type="password" id="password" name="password" on:input={(event) => { password = event.target.value; checkPassword(); }} placeholder="รหัสผ่าน">
            {#if showAlert}
  ...
  {/if}
        ...
        <button class="bg-primary w-100  border border-2" style="border-radius: 50px;color:aliceblue;height:40px" on:click={validatePasswords} >สมัครสมาชิก</button>
    </form>
        ...
        <div class="social-login">
            <div class="d-flex justify-content-center mt-3">
                ...
                <button type="button" class="border border-3 boxlogin" on:click={facebook} ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="2em"
                        height="2em"
                        viewBox="0 0 256 256"
