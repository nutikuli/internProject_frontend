...
<script>
    ...
    <div class="content-center" style="display:flex;justify-content:start; background-image:url('/src/lib/image/cyberpunk.jpg');height:100vh;">
        <div style="background-color:#fff;width:30%;" >
            ...
            <h6 style="font-size:10px;margin-top:12px" class="text-black-50">สร้างบัญชีผู้ใช้กับเว็บไซต์ของเรา</h6>
            </div>
            <div style="margin:20px 70px 20px 70px" >
                <div>
                <h6 style="font-size:16px;">ชื่อ-นามสกุล :</h6>
                <input type="email" id="email" name="name" placeholder="ชื่อ -  นามสกุล" style="margin: 0px 0px 10px 0px;border-radius:8px;width:100%;height:40px;padding-left: 10px;" >
                </div>
                <div>
                <h6 style="font-size:16px;">ที่อยู่ :</h6>
                <input  type="password" id="password" name="address" placeholder="address"  style="border-radius:8px;width:100%;height:120px;padding-left: 10px;">
                </div>
                <div>
                ...
                <div>
                    <h6 style="font-size:16px;">เบอร์โทร :</h6>
                    <input type="email" id="email" name="tel" placeholder="tel" style="margin: 0px 0px 10px 0px;border-radius:8px;width:100%;height:40px;padding-left: 10px;" >
                </div>
                <div>
                    <h6 style="font-size:16px;">รหัสผ่าน :</h6>
                    <input type="email" id="email" name="password" placeholder="password" style="margin: 0px 0px 10px 0px;border-radius:8px;width:100%;height:40px;padding-left: 10px;" >
                </div>
                <div>
                    <h6 style="font-size:16px;">ยืนยันรหัสผ่าน :</h6>
                    <input type="email" id="email" name="confirm-password" placeholder="password" style="margin: 0px 0px 10px 0px;border-radius:8px;width:100%;height:40px;padding-left: 10px;" >
                </div>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        ...
                        <div  class="border border-3 boxlogin"><svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 256 256" {...$$props}>
                        ...
                        <div class="border border-3 boxlogin"><svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24" {...$$props}>
