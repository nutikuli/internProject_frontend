<script>
    ...
    <div class="content-center">
        <div class="form-container" >
            ...
            <form method="post" action="?/signUpStore">
            <div style="margin:20px 70px 20px 70px" >
                <div>
                <h6 style="font-size:16px;">ชื่อ-นามสกุล :</h6>
                <input type="text" id="name" name="name" placeholder="ชื่อ -  นามสกุล" style="margin: 0px 0px 10px 0px;border-radius:8px;width:100%;height:40px;padding-left: 10px;" >
                </div>
                <div>
                    <h6 style="font-size:16px;">ชื่อร้านค้า :</h6>
                    <input type="text" id="store-name" name="storename" placeholder="ชื่อร้านค้า" style="margin: 0px 0px 10px 0px;border-radius:8px;width:100%;height:40px;padding-left: 10px;" >
                    </div>
                <div>
                <h6 style="font-size:16px;">ที่อยู่ :</h6>
                <input  type="text" id="address" name="address" placeholder="address"  style="border-radius:8px;width:100%;height:120px;padding-left: 10px;">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="tel" name="tel" placeholder="tel" style="margin: 0px 0px 10px 0px;border-radius:8px;width:100%;height:40px;padding-left: 10px;" >
                </div>
                <div>
                    <h6 style="font-size:16px;">รหัสผ่าน :</h6>
                    <input type="password" id="password" name="password" placeholder="password" style="margin: 0px 0px 10px 0px;border-radius:8px;width:100%;height:40px;padding-left: 10px;" >
                </div>
                <div>
                    <h6 style="font-size:16px;">ยืนยันรหัสผ่าน :</h6>
                    <input type="password" id="confirm-password" name="confirm-password" placeholder="password" style="margin: 0px 0px 10px 0px;border-radius:8px;width:100%;height:40px;padding-left: 10px;" >
                </div>
