...
<script>
	...
	/** @type {string[]} */
	export let colLabels = ['#', 'รหัสผู้ดูแลระบบ', 'ชื่อ-นามสกุล ','อีเมล', 'เบอร์โทรศัพท์', 'สิทธิผู้ใช้งาน','สถานะ', 'Title'];
											...
											<div class="modal-body">
											  ...
											  <div class="mb-3 row">
												...
												<div class="mb-3 row">
												  ...
												  <div class="col-sm-10">
													<input type="int" placeholder="placeholder" class="form-control" id="inputtel" maxlength="10">
												  </div>
												</div>
												<div class="mb-3 row">
												...
												<div class="mb-3 row">
												  ...
												  <div class="col-sm-10">
													<input type="email" placeholder="placeholder" class="form-control" id="inputPassword" maxlength="100">
												  </div>
												</div>
												<div class="mb-3 row">
