...
<script>
	import ProductEditor from './ProductCategoryEditor.svelte';
	...
	import ProductCategoryEditor from './ProductCategoryEditor.svelte';
							...
							{#if actionSelects.includes('EDIT')}
								...
								<ProductCategoryEditor
									props={{
										index,
										store_id,
										product_category_id: record[1].split('-')[1],
										productCate,
										record
									}}
								/>
